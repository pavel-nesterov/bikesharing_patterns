...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        if loglevel == "debug": print("training finished", counter)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # было error = y[0] - final_outputs
        error = y - final_outputs # Output layer error is the difference between desired target and actual output.
        if loglevel == "debug": print("error shape and value ", error.shape, error)
        
        
        # TODO: Backpropagated error terms - Replace these values with your calculations.
        #before Salil's answer here https://knowledge.udacity.com/questions/341578 
        # it was output_error_term = final_outputs * error
...
output_nodes = 1
#loglevel= "debug"
loglevel = "Normal" #debug Normal
log_display_values = "False" #True False
